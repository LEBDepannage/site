    ...
    <section className="py-20 max-lg:landscape:py-12 md:py-28 bg-white">
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="text-center max-w-4xl mx-auto">
          <p className="text-sm max-lg:landscape:text-xs font-bold text-primary uppercase tracking-widest mb-4 max-lg:landscape:mb-3 letterSpacing-[0.15em]">
            {data.sectionLabel}
          </p>
          <h2 className="text-3xl max-lg:landscape:text-2xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 max-lg:landscape:mb-4 leading-tight">
            {data.title}
          </h2>
